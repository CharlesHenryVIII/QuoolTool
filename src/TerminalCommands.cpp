...
const char* g_script_network_text = R"term(powershell -NoProfile -Command "Get-CimInstance Win32_NetworkAdapterConfiguration | )term"
R"term(Select-Object Description, IPEnabled, IPAddress, IPSubnet, SettingID, DefaultIPGateway, DHCPEnabled, DHCPServer, DNSDomain, DNSDomainSuffixSearchOrder, DNSHostName, DomainDNSRegistrationEnabled, MACAddress | )term"
R"term(ConvertTo-Xml -As String")term";
...
#else
const char* g_script_disk_text = R"term(powershell -command "Get-PhysicalDisk | Select FriendlyName, Size, MediaType, BusType | )term"
CSV_CONVERT_TEXT;
#endif
